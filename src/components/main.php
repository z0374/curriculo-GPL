...
$style[] = file_get_contents(ROOT_PATH_CURRICULO . "/assets/css/reset.css");
style[] = file_get_contents(ROOT_PATH_CURRICULO . "/assets/css/main.css");
media_desktop_landscape_geral [] = file_get_contents(ROOT_PATH_CURRICULO . "/assets/css/desktopL.css");
